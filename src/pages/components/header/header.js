...
import { NavLink, Link } from 'src/pages/components/link';
import { DrawerProvider } from 'src/pages/contexts/drawer/drawer-provider';
                ...
                <Flex as="nav" sx={styles.navbar} className="navbar">
                  <Box as="ul" sx={styles.navList}>
                    {menuItems.map(({ path, label, link }, i) => (
                      <li key={i}>
                        {
                          link == 'true' ? <Link path={path} label={label} >{label}</Link> : <NavLink path={path} label={label} />
                        }                        
                  ...
                  <Button variant="text" sx={styles.getStartedDesktop}>
                    <Link path={'/get_started'}>Get Started</Link>
                  </Button>
                </Flex>
